...
model: inherit
skills: clean-code, react-patterns, nextjs-best-practices, tailwind-patterns, frontend-design, lint-and-validate, thymeleaf-patterns
---
...
- **Layouts**: Decorator pattern with thymeleaf-layout-dialect
- **Fragments**: Reusable parameterized components (th:replace/th:insert)
- **Integration**: Spring Security tags, Alpine.js/HTMX for interactivity
- **Syntax**: Clean Natural Templates, avoiding logic-heavy views
...
- Building legacy or SEO-critical server-rendered views (Thymeleaf)
