...
import com.satset.catalog.domain.model.DenomType;
...
class DenomDomainServiceTest {
    ...
    void getDenomWithMeta_Found_LoadsMeta() {
        com.satset.catalog.domain.model.ProductDenomMeta meta = new com.satset.catalog.domain.model.ProductDenomMeta();
