...
class AdminCatalogControllerTest {
    ...
    void getDenom_Found_ReturnsOk() throws Exception {
        UUID id = UUID.randomUUID();
        UUID productId = UUID.randomUUID();
        com.satset.catalog.domain.model.ProductDenoms denom = buildDenom(id, productId);
    ...
    void createDenom_ReturnsCreated() throws Exception {
        UUID productId = UUID.randomUUID();
        com.satset.catalog.domain.model.ProductDenoms created = buildDenom(UUID.randomUUID(), productId);
    ...
    void updateDenom_ReturnsOk() throws Exception {
        UUID id = UUID.randomUUID();
        UUID productId = UUID.randomUUID();
        com.satset.catalog.domain.model.ProductDenoms updated = buildDenom(id, productId);
    ...
    private com.satset.catalog.domain.model.ProductDenoms buildDenom(UUID id, UUID productId) {
        Products product = new Products();
        product.setId(productId);
        product.setCode("TEL");
        product.setName("Telkomsel");

        com.satset.catalog.domain.model.ProductDenoms denom = new com.satset.catalog.domain.model.ProductDenoms();
        denom.setId(id);
