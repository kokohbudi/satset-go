...
public class IdentityController {
    ...
    @PreAuthorize("hasRole('REALM_assign_user_to_groups') and @authz.targetIsNotCurrentUser(#userId)")
    ...
    @PreAuthorize("hasRole('REALM_manage_users')")
    ...
    @PreAuthorize("hasRole('REALM_assign_user_to_groups')")
    ...
    @PreAuthorize("hasRole('REALM_create_users')")
    ...
    @PreAuthorize("hasRole('REALM_manage_users') and @authz.targetIsNotCurrentUser(#targetProviderUserId)")
