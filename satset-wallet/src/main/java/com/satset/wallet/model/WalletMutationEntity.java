...
public class WalletMutationEntity {
    ...
    /**
     * Builds a new (unpersisted) mutation. Id and createdAt are assigned on persist.
     */
    public static WalletMutationEntity of(String walletId, BigDecimal amount, MutationType mutationType,
        ...
        entity.setMutationType(mutationType);
