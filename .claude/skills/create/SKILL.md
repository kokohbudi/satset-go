...
- `.agent/skills/app-builder/tech-stack.md` for tech stack selection
- `.agent/skills/app-builder/agent-coordination.md` for multi-agent coordination
- `.agent/skills/app-builder/templates/` for project templates (13 available)
